...
describe('timeline/otioSerializer', () => {
  it('roundtrips OTIO and preserves item durations', () => {
    ...
    const doc = parseTimelineFromOtio(JSON.stringify(input), {
      id: 'fallback',
      name: 'fallback',
      fps: 25,
    });
  ...
  it('preserves stable clip id and explicit timeline start across roundtrip', () => {
    const input = {
      OTIO_SCHEMA: 'Timeline.1',
      name: 'Demo',
      tracks: {
            ...
            children: [
              ...
              },
              {
                ...
                source_range: {
                  ...
                  duration: { OTIO_SCHEMA: 'RationalTime.1', value: 1_500_000, rate: 1_000_000 },
                },
                metadata: {
                  gran: {
                    id: 'clip_stable_a',
