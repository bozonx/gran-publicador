...
const { t, d } = useI18n()
const { news, isLoading, error, searchNews } = useNews()
...
<template>
  <div>
    ...
    <div
      ...
      class="text-center py-12 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-dashed border-gray-200 dark:border-gray-700"
    >
      <UIcon name="i-heroicons-magnifying-glass" class="w-12 h-12 mx-auto mb-3 text-gray-400" />
      <p>{{ t('news.searchPlaceholder') }}</p>
    </div>
  </div>
</template>
