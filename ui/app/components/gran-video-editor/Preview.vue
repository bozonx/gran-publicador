  ...
  <div class="flex flex-col h-full bg-gray-950">
    ...
    <div class="flex-1 flex items-center justify-center">
      <div class="flex flex-col items-center gap-3 text-gray-700">
        ...
        <p class="text-sm">
          {{ t('granVideoEditor.preview.empty', 'No clip selected') }}
        </p>
      </div>
    </div>
    ...
    <div class="flex items-center justify-center gap-3 px-4 py-3 border-t border-gray-700 shrink-0">
      <UButton
        ...
        :aria-label="t('granVideoEditor.preview.rewind', 'Rewind')"
        disabled
      />
      <UButton
        size="sm"
        ...
        :aria-label="t('granVideoEditor.preview.play', 'Play')"
        disabled
      />
      <UButton
        size="sm"
        ...
        :aria-label="t('granVideoEditor.preview.forward', 'Forward')"
        disabled
      />
      <span class="text-xs text-gray-600 ml-2 font-mono">00:00 / 00:00</span>
    </div>
  </div>
</template>
