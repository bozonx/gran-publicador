...
async function main() {
  ...
  const projectData = [
    {
      ...
      name: 'Future Tech 🚀',
      note: 'Advanced tutorials on Node.js, Rust and AI agents. Target audience: Professional developers.',
      ownerId: devUser.id,
      preferences: {},
    },
    {
      ...
      note: 'Photo stories from around the world. Budget travel tips and luxury resort reviews.',
      ownerId: devUser.id,
      preferences: {},
    },
    {
      ...
      name: 'Finance & Crypto 💰',
      note: 'Market analysis and investment strategies. Not financial advice.',
    ...
    },
    {
      ...
      note: 'A project designed specifically to break the UI with long strings and edge cases.',
      ownerId: devUser.id,
      preferences: {},
    },
    {
      ...
      note: 'Project specifically for testing pagination with many posts.',
      ownerId: devUser.id,
      preferences: {},
    },
    {
      ...
      note: 'Project for testing stale channel warnings.',
      ownerId: devUser.id,
      preferences: {},
    },
    {
      ...
      note: 'Project with various problems regarding activity and channels.',
      ownerId: devUser.id,
      preferences: {},
    },
  ];
  ...
  const publications = [
    ...
    },
    {
      ...
      postType: PostType.NEWS,
      language: 'ru-RU',
      meta: { newsItemId: 'news-item-123456789', originalUrl: 'https://example.com/news/123' },
      createdAt: new Date(),
    },
    {
  ...
  const promptTemplates = [
    // Personal templates for devUser
    {
      ...
      note: 'Creates a short summary for Telegram posts',
      category: 'Content',
      prompt:
    ...
    // Project templates
    {
      ...
      note: 'Rewrites text in a technical tone',
      category: 'Editing',
      prompt:
